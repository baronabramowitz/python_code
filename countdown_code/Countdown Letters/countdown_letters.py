...
wcl = [letters.count(letter) for letter in [chr(i)
...
print('One:   ', match_list[len(match_list) - 1],
      '(', len(match_list[len(match_list) - 1]), ')')
print('Two:   ', match_list[len(match_list) - 2],
      '(', len(match_list[len(match_list) - 2]), ')')
print('Three: ', match_list[len(match_list) - 3],
      '(', len(match_list[len(match_list) - 3]), ')')
print('Four:  ', match_list[len(match_list) - 4],
      '(', len(match_list[len(match_list) - 4]), ')')
print('Five:  ', match_list[len(match_list) - 5],
      '(', len(match_list[len(match_list) - 5]), ')')
