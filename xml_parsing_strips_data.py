...
def test_xml():
	...
	xw.Book(r'/Users/baronabramowitz/Desktop/xlwings_testing_doc.xlsx').sheets('Sheet2').range('A1').value = pattern_g1_matches_df
	xw.Book(r'/Users/baronabramowitz/Desktop/xlwings_testing_doc.xlsx').sheets('Sheet2').range('A1').options(pd.DataFrame, expand='table').value
	xw.Book(r'/Users/baronabramowitz/Desktop/xlwings_testing_doc.xlsx').sheets('Sheet2').range('C1').value = pattern_g2_matches_df
	xw.Book(r'/Users/baronabramowitz/Desktop/xlwings_testing_doc.xlsx').sheets('Sheet2').range('C1').options(pd.DataFrame, expand='table').value
